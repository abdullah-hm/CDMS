...
if (isset($_POST['submit'])) {
    ...
    if ($np == $cp) {
        ...
        $query = mysqli_query($con, "select * from patient where  Email='$email' and Nic='$nic'");
        $ret = mysqli_fetch_array($query);

        if ($ret > 0) {

            $query1 = mysqli_query($con, "update patient set Password='$cp' where Email='$email'");
                    ...
                    <form method="post" name="login">
                        <div class="row">
                            <div class="input-field center-align col s12">
                                ...
                                <h5 class="ml-4 font-weight-900">Patient Password Recovery</h5>
                            </div>
                        </div>
