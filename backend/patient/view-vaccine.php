...
$title = "View Vaccine Appointment Dashboard";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10">
                            <h1>Patient | View Vaccine Appointment Dashboard</h1>
                        </div>
                        <div class="col-sm-2">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        $query = mysqli_query($con, "select * from vaccine where PtnMobileNo='$mn'");
                                        $cnt = 1;
