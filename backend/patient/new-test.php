...
$title = "New Testing Appointment Dashboard";
include("../AdminLTE/header.php");

if (isset($_POST['submit'])) {
//getting post values

    $mnumber = $_SESSION['MobileNo'];
    $testtype = $_POST['testtype'];
    $timeslot = $_POST['appdaytime'];
    ...
    if ($result) {
        echo '<script>alert("Your test request successfully submitted. Order number is "+"' . $orderno . '")</script>';
        echo "<script>window.location.href='view-tests.php'</script>";
    } else {
        echo "<script>alert('Something went wrong. Please try again.');</script>";
        echo "<script>window.location.href='new-test.php'</script>";
    }
}
    ...
    <script>
        function datetimeAvailability() {
            ...
            jQuery.ajax({
                ...
                data: 'datetimetest=' + $("#appdaytime").val(),
                type: "POST",
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="new-test.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-10">
                            <h1>Patient | New Test Appointment Dashboard</h1>
                        </div>
                        <div class="col-sm-2">
                            ...
                            <div class="offset-lg-3 col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Add Test Appointment</h6>
                                    </div>
                                    <div class="card-body">
