...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "select * from patient where  Email='$email' && Password='$password' ");
    $ret = mysqli_fetch_array($query);

    if ($ret > 0) {

        $_SESSION['PID'] = $ret['pid'];
        $_SESSION['MobileNo'] = $ret['MobileNo'];
        $_SESSION['FlName'] = $ret['FullName'];
...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-gradient-menu preload-transitions 1-column login-bg-3   blank-page blank-page"
    ...
    <div class="col s12 ">
        <div class="container">
            <div id="login-page" class="row">
                <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-10">
                    <form method="post" name="login">
                        <div class="row">
                            <div class="input-field center-align col s12">
                                <h5 class="ml-4">Zone Health Care</h5>
                                <h5 class="ml-4 font-weight-900">Patient Login</h5>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                <button class="btn waves-effect font-weight-500 waves-light white-text border-round gradient-45deg-cyan-light-green col s12"
