...
$title = "View Test Appointment Dashboard";
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="view-report.php?tid=<?php echo $row['testid']; ?>&&oid=<?php echo $row['OrderNumber']; ?>"
                                                       class="btn btn-info btn-sm" target="blank">View Report</a>
