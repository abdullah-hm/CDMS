...
$query = mysqli_query($con, "select * from patient where pid='$pid'");
$cnt = 1;
...
//getting post values
    ...
    $query1 = "update patient set FullName='$flname',MobileNo='$mobile',Nic='$nic',Dob='$dob',Gender='$gender',Address='$addr',District='$district',Email='$email',Password='$pwd'  where pid='$pid'";
    ...
    if ($result) {
        ...
        echo "<script>alert('Patient record went wrong. Please try again.');</script>";
        echo "<script>window.location.href='manage-patient.php'</script>";
    }
}
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">ADMIN | Update Patient</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <div class="form-group col-sm-6 col-md-6">
                                            ...
                                            <select class="form-control select2bs4" id="state" name="district"
                                                    data-placeholder="Select District" style="width: 100%"
                                                    required="true">

                                                <option><?= $row['District'] ?></option>
                                                <?php
                                                $checkstate = $row['District'];
                                                $districts = [
                                                    'Ampara District',
                                                ...
                                                foreach ($districts as $district) {
                                                    ...
                                                    if ($checkstate == $district) {
                                                        echo "<option disabled>$district</option>";
                                                    } else {
                                        ...
                                        <div class="form-group col-sm-6 col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" value="<?= $row['MobileNo']; ?>"
                                                       name="mob"
                                                       class="form-control" minlength="9" maxlength="10" readonly>
                                                <div class="input-group-prepend">
                                                <span class="input-group-text"><i
