...
if ($_GET['action'] == 'update') {
    $id = intval($_GET['id']);
    $st = "Solved";
    $query = mysqli_query($con, "update contactus set  status='$st' where id='$id'");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">ADMIN | ContactUs Management</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="card col-lg-12 col-sm-12">
                            <div class="card-header ">
                                <h3>List of All ContactUs Details
                                    <a href="reports/export-contactus-data.php" class="no-print btn btn-success float-right"><i
                            ...
                            <div class="card-body">
                                <table id="example1" class=" table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php $query = mysqli_query($con, "select * from contactus");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="contactus.php?id=<?php echo $row['id']; ?>&&action=update">
                                                    <i class="fa fa-check-circle" aria-hidden="true" style="color:green"
                                                       title="Update Status"></i>
                                                </a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="contactus.php?id=<?php echo $row['id']; ?>&&action=delete">
