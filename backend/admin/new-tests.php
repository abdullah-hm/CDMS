            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="new-tests.php" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">ADMIN | Test Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                    ...
                    <div class="card col-lg-12 col-sm-12">
                        ...
                        <div class="card-body">
                            <table id="example1" class=" table table-bordered table-hover">
                                ...
                                <tbody>
                                <?php $query = mysqli_query($con, "select testrecord.OrderNumber,
                                        patient.FullName,
                                        patient.MobileNo,
                                        testrecord.TestType,
                                        testrecord.TestTimeSlot,
                                        testrecord.RegistrationDate,
                                        testrecord.id as testid from testrecord
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="test-details.php?tid=<?php echo $row['testid']; ?>&&oid=<?php echo $row['OrderNumber']; ?>"
                                               class=" "> <i class="fas fa-eye" style="color:green"></i></a>

                                            &nbsp;
                                            &nbsp;
                                            &nbsp;
                                            &nbsp;
                                            <a href="new-tests.php?ordernumber=<?php echo $row['OrderNumber']; ?>&&action=delete"
