...
//getting post values
    ...
    $query = "insert into patient(FullName,MobileNo,Nic,Dob,Address,District,Email,Password) 
values('$flname','$mobile','$nic','$dob','$addr','$district','$email','$pwd')";
    ...
    if ($result) {
        ...
        header("refresh:1;url=add-patient.php");
    }
}
...
<script>
    function patientAvailability() {
        ...
        jQuery.ajax({
            ...
            data: 'PtnMail=' + $("#PtnMail").val(),
            type: "POST",
            success: function (data) {
                $("#patient-availability-status").html(data);
                $("#loaderIcon").hide();
            },
            error: function () {
            }
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="add-patient.php" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">ADMIN | Add Patient</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <form method="post" name="addemployee">
                        ...
                        <div class="card card-default">
                            ...
                            <span id="patient-availability-status"></span>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="email" placeholder="Enter Email Address"
                                                   name="mail" id="PtnMail"
                                                   class="form-control" onblur="patientAvailability()" required>
                                    ...
                                    <div class="input-group col-sm-6 col-md-6">
                                        ...
                                        <select class="form-control select2" id="state" name="district"
                                                data-placeholder="Select District" style="width: 100%" required>
