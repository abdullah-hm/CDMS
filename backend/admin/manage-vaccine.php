...
$title = "Manage Vaccine Dashboard";
...
if ($_GET['action'] == 'available') {
    $id = intval($_GET['id']);
    $st = "Available";
    $query = mysqli_query($con, "update vaccinetype set  Status='$st' where id='$id'");
...
if ($_GET['action'] == 'delete') {
    $id = intval($_GET['id']);
    $query = mysqli_query($con, "delete from vaccinetype where id='$id'");
    echo '<script>alert("Vaccine Record deleted")</script>';
    echo "<script>window.location.href='manage-vaccine.php'</script>";
}
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">ADMIN | Manage Vaccine</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="card col-lg-12 col-sm-12">
                            <div class="card-header ">
                                <h3>List of All Vaccine
                                    <a href="reports/export-vaccine-data.php" class="no-print btn btn-success float-right"><i
                            ...
                            <div class="card-body">
                                <table id="example1" class=" table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php $query = mysqli_query($con, "select * from vaccinetype");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="manage-vaccine.php?id=<?php echo $row['id']; ?>&&action=available">
                                                    <i class="fas fa-eye" aria-hidden="true" style="color:green"
                                                       title="Available Status"></i>
                                                </a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="manage-vaccine.php?id=<?php echo $row['id']; ?>&&action=unavailable">
                                                    <i class="fas fa-eye-slash" aria-hidden="true" style="color:blue"
                                                       title="Unavailable Status"></i>
                                                </a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="manage-vaccine.php?id=<?php echo $row['id']; ?>&&action=delete">
