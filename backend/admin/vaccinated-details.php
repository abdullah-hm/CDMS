...
$title = "Patient Vaccinated Details";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">ADMIN | Patient Vaccine Details</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="card col-lg-12 col-sm-12">
                            <div class="card-header ">
                                <h3>List of All Patient Vaccine Details
                                    <a href="reports/export-vaccinated-data.php" class="no-print btn btn-success float-right"><i
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <?php
                                    $pid = $_SESSION['PID'];
                                    $query = mysqli_query($con, "select * from vaccine join patient on patient.MobileNo=vaccine.PtnMobileNo");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="view-vaccinated-details.php?vid=<?php echo $row['vid']; ?>">
                                                    <i class="fas fa-eye" style="color:blue"></i></a>
