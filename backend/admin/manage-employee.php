    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">ADMIN | Employee Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="card col-lg-12 col-sm-12">
                        <div class="card-header ">
                            ...
                            <a href="reports/export-employee-data.php" class="no-print btn btn-success float-right"><i
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="edit-employee.php?eid=<?php echo $row['eid']; ?>">
                                                <i class="fas fa-edit" style="color:blue"></i>
                                            </a>&nbsp;|&nbsp;

                                            <a href="manage-employee.php?eid=<?php echo $row['eid']; ?>&&action=delete"
