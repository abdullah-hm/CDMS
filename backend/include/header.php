...
<head>
    ...
    <title>Zone Health Care | <?= $title; ?> </title>

    <link rel="apple-touch-icon" href="../app-assets/images/favicon/apple-touch-icon-152x152.png">
    <link rel="shortcut icon" type="image/x-icon" href="../app-assets/images/favicon/logo.png">
    ...
    <link rel="stylesheet" type="text/css" href="../app-assets/vendors/verti">
    ...
    <!-- Own CSS external file stating form here...-->
    <link rel="stylesheet" type="text/css" href="../app-assets/background.css">
