...
if (isset($_POST['submit'])) {
    ...
    if ($np == $cp) {
        ...
        $query = mysqli_query($con, "select * from employee where  Email='$email' and Nic='$nic'");
        $ret = mysqli_fetch_array($query);

        if ($ret > 0) {

            $query1 = mysqli_query($con, "update employee set Password='$cp' where Email='$email'");
                    ...
                    <form method="post" name="login">
                        <div class="row">
                            <div class="input-field center-align col s12">
                                ...
                                <h5 class="ml-4 font-weight-900">Employee Password Recovery</h5>
                            </div>
                        </div>
                        ...
                        <div class="row margin">
                            <div class="input-field col s12">
                                <i class="material-icons prefix pt-2">call_to_action</i>
                                <input type="text" name="nic" maxlength="12" minlength="9" required>
                                <label for="tel" class="center-align">NIC</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                <button class="btn waves-effect font-weight-500 waves-light white-text border-round gradient-45deg-deep-purple-blue col s12"
