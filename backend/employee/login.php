...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "select * from employee where  Email='$email' && Password='$password' ");
...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu login-bg-2 preload-transitions 2-columns   "
                    ...
                    <form method="post" name="login">
                        <div class="row">
                            <div class="input-field center-align col s12">
                                ...
                                <h5 class="ml-4 font-weight-900">Employee Login</h5>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                <button class="btn waves-effect font-weight-500 waves-light white-text border-round gradient-45deg-blue-indigo col s12"
