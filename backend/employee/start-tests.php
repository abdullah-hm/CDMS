        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Employee | Start Tests Dashboard</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        $query = mysqli_query($con, "select testrecord.OrderNumber,patient.FullName,patient.MobileNo,testrecord.TestType,testrecord.TestTimeSlot,testrecord.RegistrationDate,testrecord.id as testid from testrecord
                                                                    join patient on patient.MobileNo=testrecord.PatientMobileNumber where ReportStatus='Start Test' && AssignedtoEmpId='$empid' ");
                                        $cnt = 1;
